...
var FormCheck = new Class({
	...
	options : {
		...
		display : {
            ...
            alerts : {
            required: "Det h&auml;r f&auml;ltet &auml;r obligatoriskt.",
            alpha: "Det h&auml;r f&auml;ltet till&aring;ter bara bokst&auml;ver.",
            alphanum: "Det h&auml;r f&auml;ltet till&aring;ter bara bokst&auml;ver och siffror.",
            nodigit: "Inga siffror &auml;r till&aring;tna.",
            digit: "Ange endast siffror utan mellanslag.",
            digitmin: "Siffran m&aring;ste vara minst %0",
            digitltd: "V&auml;rdet m&aring;ste vara mellan %0 och %1",
            number: "Skriv in en giltig siffra.",
            email: "Skriv in en giltig epostadress: <br /><span>T.ex. mittnamn@mindoman.se</span>",
            image : 'Det h&auml;r f&auml;ltet tar bara emot bilder',
            phone: "Skriv in ett giltigt telefonnummer.",
            url: "Skriv in en giltig url: <br /><span>T.ex. http://www.mindoman.se</span>",
            date: "Skriv in ett giltigt datum: <br /><span>T.ex. " + (typeof(new Date().format) == 'function' ? new Date().format("%Y-%m-%d") : '2009-04-19') + "</span>",
            confirm: "Det h&auml;r f&auml;ltet skiljer sig fr&aring;n %0",
            differs: "Det h&auml;r v&auml;rdet m&aring;ste skilja sig fr&aring;n %0",
            length_str: "Fel l&auml;ngd, det m&aring;ste vara mellan %0 och %1",
            length_fix: "Fel l&auml;ngd, det m&aring;ste vara exakt %0 tecken",
            lengthmax: "Fel l&auml;ngd, det f&aring;r vara h&ouml;gst %0",
            lengthmin: "Fel l&auml;ngd, det m&aring;ste vara minst %0",
            words_min : "Det h&auml;r f&auml;ltet m&aring;ste inneh&aring;lla minst %0 ord, just nu: %1 ord",
            words_range : "Det h&auml;r f&auml;ltet m&aring;ste inneh&aring;lla %0-%1 ord, just nu: %2 ord",
            words_max : "Det h&auml;r f&auml;ltet f&aring;r inneh&aring;lla h&ouml;gst %0 ord, just nu: %1 ord",
            checkbox: "Kryssa i den h&auml;r rutan",
            radios: "V&auml;lj en av f&ouml;ljande",
	...
	validateGroup : function(el) {
		...
		if(el.type == 'radio') {
			...
			var cbCheckeds = false;
                        cbCheckeds = nlButtonGroup.length > 0 ? false : nlButtonGroup.checked;//nlButtonGroup instanceof Array ? false : nlButtonGroup.checked;
	...
	*/
	addError : function(obj) {
		...
		if(coord.left == 0){
                   //var x = $$("div.form-reference-telegram");
			coord = $$("div.form-reference-telegram").getCoordinates();
                    if(coord == "")
                        coord = $$("div.form-reference-fadder").getCoordinates();
